...
namespace eastl
{
	...
	public:
		...
		iterator       before_begin() EASTL_NOEXCEPT;
		const_iterator before_begin() const EASTL_NOEXCEPT;
		const_iterator cbefore_begin() const EASTL_NOEXCEPT;
	...
	SListBase<T, Allocator>::getAllocator() const EASTL_NOEXCEPT
	{
		return mAllocator;
	}
	...
	SListBase<T, Allocator>::getAllocator() EASTL_NOEXCEPT
	{
		return mAllocator;
	}
	...
	template <typename T, typename Allocator>
	void
	SListBase<T, Allocator>::setAllocator(const allocator_type& allocator)
	{
	...
	slist<T, Allocator>::begin() EASTL_NOEXCEPT
	{
	...
	slist<T, Allocator>::begin() const EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::const_iterator
	slist<T, Allocator>::cbegin() const EASTL_NOEXCEPT
	{
		return const_iterator((SListNodeBase*)mNode.mpNext);
	}
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::iterator
	slist<T, Allocator>::end() EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::const_iterator
	slist<T, Allocator>::end() const EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::const_iterator
	slist<T, Allocator>::cend() const EASTL_NOEXCEPT
	{
		return const_iterator(NULL);
	}
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::iterator
	slist<T, Allocator>::before_begin() EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::const_iterator
	slist<T, Allocator>::before_begin() const EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline typename slist<T, Allocator>::const_iterator
	slist<T, Allocator>::cbefore_begin() const EASTL_NOEXCEPT
	{
		return const_iterator((SListNodeBase*)&mNode);
	}
	...
	template <typename T, typename Allocator>
	inline void slist<T, Allocator>::pushFront(const value_type& value)
	{
	...
	#if EASTL_MOVE_SEMANTICS_ENABLED
		template <typename T, typename Allocator>
		void slist<T, Allocator>::pushFront(value_type&& value)
		{
	...
	template <typename T, typename Allocator>
	void slist<T, Allocator>::popFront()
	{
		#if EASTL_ASSERT_ENABLED
			if(EASTL_UNLIKELY(mNode.mpNext == NULL))
				EASTL_FAIL_MSG("slist::front -- empty container");
	...
	template <typename T, typename Allocator>
	inline bool slist<T, Allocator>::empty() const EASTL_NOEXCEPT
	{
	...
	slist<T, Allocator>::size() const EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	inline void slist<T, Allocator>::clear() EASTL_NOEXCEPT
	{
		DoEraseAfter((SListNodeBase*)&mNode, NULL);
	}
		...
		template <typename T, typename Allocator>
		inline void slist<T, Allocator>::reset() EASTL_NOEXCEPT
		{
			reset_lose_memory();
		}
	#endif
	...
	template <typename T, typename Allocator>
	inline void slist<T, Allocator>::reset_lose_memory() EASTL_NOEXCEPT
	{
	...
	template <typename T, typename Allocator>
	template <typename Predicate>
	void slist<T, Allocator>::removeIf(Predicate predicate)
	{
		base_node_type* pNode = &mNode;
	...
	{
		// To do: look at using a merge sort, which may well be faster. 
		eastl::combSort(begin(), end(), compare);
	}



	template <typename T, typename Allocator>
	inline void slist<T, Allocator>::reverse() EASTL_NOEXCEPT
	{
		if(mNode.mpNext)
	...
	template <typename T, typename Allocator>
	inline int slist<T, Allocator>::validateIterator(const_iterator i) const
	{
