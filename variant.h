...
namespace eastl
{
	...
	public:
		...
		//
		EA_CONSTEXPR size_t index() const EASTL_NOEXCEPT { return valueless_by_exception() ? variant_npos : mIndex; }
		EA_CONSTEXPR bool valueless_by_exception() const EASTL_NOEXCEPT { return mIndex == variant_npos; }
	...
	private:
		...
		template <size_t I, class... Types2> friend EA_CONSTEXPR add_pointer_t<      variant_alternative_t<I, variant<Types2...>>> get_if(      variant<Types2...>* pv) EASTL_NOEXCEPT;
		template <size_t I, class... Types2> friend EA_CONSTEXPR add_pointer_t<const variant_alternative_t<I, variant<Types2...>>> get_if(const variant<Types2...>* pv) EASTL_NOEXCEPT;
