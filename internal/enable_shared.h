...
namespace eastl
{
	...
	protected:
		...
		EA_CONSTEXPR enable_shared_from_this() EASTL_NOEXCEPT
			{ }

		enable_shared_from_this(const enable_shared_from_this&) EASTL_NOEXCEPT
			{ }

		enable_shared_from_this& operator=(const enable_shared_from_this&) EASTL_NOEXCEPT
			{ return *this; }
