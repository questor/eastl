...
namespace eastl
{
	...
	/// copy / copy_n / copyBackward
	///
	/// We want to optimize move, move_n, move_backward, copy, copyBackward, copy_n to do memmove operations
	/// when possible.
	///
	...
	/// allows no range overlap at all, whereas move/copy allow output end overlap and move_backward/copyBackward
