...
namespace eastl
{
	...
	inline signed char* fillN(signed char* first, Size n, const signed char& c)
	{
		...
		inline bool* fillN(bool* first, Size n, const bool& b)
		{
			...
			inline uint64_t* fillN(uint64_t* first, Size n, Value c)
			{
			...
			template <typename Size, typename Value>
			inline int64_t* fillN(int64_t* first, Size n, Value c)
			{
				uintptr_t count = (uintptr_t)(n);
				int64_t   value = (int64_t)(c);
		...
		template <typename Size, typename Value>
		inline uint32_t* fillN(uint32_t* first, Size n, Value c)
		{
			uintptr_t count = (uintptr_t)(n);
			uint32_t  value = (uint32_t)(c);
		...
		template <typename Size, typename Value>
		inline int32_t* fillN(int32_t* first, Size n, Value c)
		{
			uintptr_t count = (uintptr_t)(n);
			int32_t   value = (int32_t)(c);
		...
		template <typename Size, typename Value>
		inline uint16_t* fillN(uint16_t* first, Size n, Value c)
		{
			uintptr_t count = (uintptr_t)(n);
			uint16_t  value = (uint16_t)(c);
		...
		template <typename Size, typename Value>
		inline int16_t* fillN(int16_t* first, Size n, Value c)
		{
			uintptr_t count = (uintptr_t)(n);
			int16_t   value = (int16_t)(c);
