...
namespace eastl
{
	...
	///////////////////////////////////////////////////////////////////////
		...
		#if defined(EA_COMPILER_GNUC) && (!defined(EASTL_COMPILER_CPP11_ENABLED) || (EA_COMPILER_VERSION < 4007))
	...
	#define EASTL_TYPE_TRAIT_is_constructible_CONFORMANCE 1
		...
		template <typename T>
		inline typename eastl::remove_reference<T>::type&& move_internal(T&& x) EASTL_NOEXCEPT
	...
	#define EASTL_TYPE_TRAIT_is_trivial_CONFORMANCE ((EASTL_TYPE_TRAIT_is_trivially_default_constructible_CONFORMANCE && EASTL_TYPE_TRAIT_is_trivially_copyable_CONFORMANCE) ? 1 : 0)
		...
		template <typename T>
		struct is_trivial
			: public is_trivial_helper<(EASTL_ALIGN_OF(T) > EA_PLATFORM_MIN_MALLOC_ALIGNMENT), T>::type{};
	#else
