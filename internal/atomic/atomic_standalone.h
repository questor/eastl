...
EASTL_FORCE_INLINE bool atomic_compare_exchange_strong(eastl::atomic<T>* atomicObj,
													   ...
													   typename eastl::atomic<T>::value_type desired) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE bool atomic_compare_exchange_strong_explicit(eastl::atomic<T>* atomicObj,
																...
																OrderSuccess orderSuccess, OrderFailure orderFailure) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_fetch_xor(eastl::atomic<T>* atomicObj,
																		  typename eastl::atomic<T>::value_type arg) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_fetch_sub(eastl::atomic<T>* atomicObj,
																		  typename eastl::atomic<T>::difference_type arg) EASTL_NOEXCEPT
{
...
//
template <typename T>
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_load(const eastl::atomic<T>* atomicObj) EASTL_NOEXCEPT
{
	return atomicObj->load();
}

template <typename T, typename Order>
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_load_explicit(const eastl::atomic<T>* atomicObj, Order order) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_load_cond(const eastl::atomic<T>* atomicObj, Predicate pred) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE typename eastl::atomic<T>::value_type atomic_load_cond_explicit(const eastl::atomic<T>* atomicObj, Predicate pred, Order order) EASTL_NOEXCEPT
{
	typename eastl::atomic<T>::value_type ret;
...
//
template <typename T>
EASTL_FORCE_INLINE void atomic_store(eastl::atomic<T>* atomicObj, typename eastl::atomic<T>::value_type desired) EASTL_NOEXCEPT
{
	atomicObj->store(desired);
}

template <typename T, typename Order>
EASTL_FORCE_INLINE void atomic_store_explicit(eastl::atomic<T>* atomicObj, typename eastl::atomic<T>::value_type desired, Order order) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE void atomic_thread_fence(Order) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_STATIC_ASSERT_INVALID_MEMORY_ORDER(Order);
}

EASTL_FORCE_INLINE void atomic_thread_fence(eastl::internal::memory_order_relaxed_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_THREAD_FENCE_RELAXED();
}

EASTL_FORCE_INLINE void atomic_thread_fence(eastl::internal::memory_order_acquire_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_THREAD_FENCE_ACQUIRE();
}

EASTL_FORCE_INLINE void atomic_thread_fence(eastl::internal::memory_order_release_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_THREAD_FENCE_RELEASE();
}

EASTL_FORCE_INLINE void atomic_thread_fence(eastl::internal::memory_order_acq_rel_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_THREAD_FENCE_ACQ_REL();
}

EASTL_FORCE_INLINE void atomic_thread_fence(eastl::internal::memory_order_seq_cst_s) EASTL_NOEXCEPT
{
...
//
template <typename Order>
EASTL_FORCE_INLINE void atomic_signal_fence(Order) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_STATIC_ASSERT_INVALID_MEMORY_ORDER(Order);
}

EASTL_FORCE_INLINE void atomic_signal_fence(eastl::internal::memory_order_relaxed_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_SIGNAL_FENCE_RELAXED();
}

EASTL_FORCE_INLINE void atomic_signal_fence(eastl::internal::memory_order_acquire_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_SIGNAL_FENCE_ACQUIRE();
}

EASTL_FORCE_INLINE void atomic_signal_fence(eastl::internal::memory_order_release_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_SIGNAL_FENCE_RELEASE();
}

EASTL_FORCE_INLINE void atomic_signal_fence(eastl::internal::memory_order_acq_rel_s) EASTL_NOEXCEPT
{
	EASTL_ATOMIC_SIGNAL_FENCE_ACQ_REL();
}

EASTL_FORCE_INLINE void atomic_signal_fence(eastl::internal::memory_order_seq_cst_s) EASTL_NOEXCEPT
{
...
//
EASTL_FORCE_INLINE void compiler_barrier() EASTL_NOEXCEPT
{
...
//
template <typename T>
EASTL_FORCE_INLINE void compiler_barrier_data_dependency(const T& val) EASTL_NOEXCEPT
{
...
//
EASTL_FORCE_INLINE void cpu_pause() EASTL_NOEXCEPT
{
	EASTL_ATOMIC_CPU_PAUSE();
}
...
//
template <typename T>
EASTL_FORCE_INLINE bool atomic_is_lock_free(const eastl::atomic<T>* atomicObj) EASTL_NOEXCEPT
{
