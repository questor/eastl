...
template <typename T>
EASTL_FORCE_INLINE volatile T* AtomicVolatileCast(T* ptr) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE volatile Integral* AtomicVolatileIntegralCast(T* ptr) EASTL_NOEXCEPT
{
...
template <typename Integral, typename T>
EASTL_FORCE_INLINE Integral* AtomicIntegralCast(T* ptr) EASTL_NOEXCEPT
{
	static_assert(eastl::is_integral<Integral>::value, "eastl::atomic<T> : Integral cast must cast to an Integral type!");
	static_assert(sizeof(Integral) == sizeof(T), "eastl::atomic<T> : Integral and T must be same size for casting!");
...
EASTL_FORCE_INLINE volatile ToType* AtomicVolatileTypeCast(FromType* ptr) EASTL_NOEXCEPT
{
...
template <typename ToType, typename FromType>
EASTL_FORCE_INLINE ToType* AtomicTypeCast(FromType* ptr) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE Pun AtomicTypePunCast(const T& fromType) EASTL_NOEXCEPT
{
...
template <typename T>
EASTL_FORCE_INLINE T AtomicNegateOperand(T val) EASTL_NOEXCEPT
{
...
EASTL_FORCE_INLINE ptrdiff_t AtomicNegateOperand(ptrdiff_t val) EASTL_NOEXCEPT
{
	return -val;
}
