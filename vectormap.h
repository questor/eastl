...
/* These are the same thing as sorted vectors as described in Effective STL. The underlying container is not 
limited to being a vector but can be any random access container, such as deque or array. Recall that the 
characteristic of these containers is that they provide improved memory efficiency and locality at the cost 
of dynamic container modification efficiency. */
