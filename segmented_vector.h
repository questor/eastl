...
namespace eastl
{
	...
	segmented_vector<T, Count, Allocator>::getAllocator() noexcept
	{
		return mAllocator;
	}
	...
	template <typename T, size_t Count, typename Allocator>
	inline T&
	segmented_vector<T, Count, Allocator>::pushBack(T&& value)
	{
	...
	{
		// This is only marginally better than doing consecutive popBack() calls, is it worth it?
	...
	{
		// This is only marginally better than doing consecutive pushBack(v) calls, is it worth it?
