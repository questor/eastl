...
namespace eastl
{
	...
	namespace Internal
	{
		...
		struct optional_storage
		{
			...
			inline optional_storage() EASTL_NOEXCEPT : empty_val('\0') {}
	...
	public:
	    ...
	    inline optional() EASTL_NOEXCEPT {}
	    inline optional(nullopt_t) EASTL_NOEXCEPT {}
	    inline optional(const value_type& value) : base_type(value) {}
	    inline optional(value_type&& value) EASTL_NOEXCEPT_IF(eastl::is_nothrow_move_constructible<T>::value)
