...
namespace eastl
{
	...
	#else
		#define EASTL_OPTIONAL_NOEXCEPT EASTL_NOEXCEPT
	#endif
	...
	///
		...
		struct bad_optional_access : public std::logic_error
		{
			...
			virtual ~bad_optional_access() EASTL_NOEXCEPT {}
		};
	#endif
	...
	namespace Internal
	{
		...
		struct optional_storage
		{
			...
			optional_storage() EASTL_NOEXCEPT = default;
	...
	public:
	    ...
	    inline EA_CONSTEXPR optional() EASTL_NOEXCEPT {}
	    inline EA_CONSTEXPR optional(nullopt_t) EASTL_NOEXCEPT {}
	    inline EA_CONSTEXPR optional(const value_type& value) : base_type(value) {}
		inline EA_CONSTEXPR optional(value_type&& value) EASTL_NOEXCEPT_IF(eastl::is_nothrow_move_constructible_v<T>)
	    ...
	    inline optional& operator=(optional&& other)
	        EASTL_NOEXCEPT_IF(EASTL_NOEXCEPT(eastl::is_nothrow_move_assignable<value_type>::value &&
		...
		EA_CONSTEXPR inline bool has_value() const EASTL_NOEXCEPT { return engaged; }
	    ...
	    inline void swap(optional& other)
	        EASTL_NOEXCEPT_IF(eastl::is_nothrow_move_constructible<T>::value&& eastl::is_nothrow_swappable<T>::value)
	    {
		    using eastl::swap;
		    if (engaged == other.engaged)
		    {
	...
	///
    template <class T>
    void swap(optional<T>& lhs, optional<T>& rhs) EASTL_NOEXCEPT_IF(EASTL_NOEXCEPT(lhs.swap(rhs)))
		{ lhs.swap(rhs); }
    ...
    template <class T>
    inline EA_CONSTEXPR bool operator<(const optional<T>&, eastl::nullopt_t) EASTL_NOEXCEPT
		{ return false; }
    ...
    template <class T>
    inline EA_CONSTEXPR bool operator<=(eastl::nullopt_t, const optional<T>&) EASTL_NOEXCEPT
		{ return true; }
