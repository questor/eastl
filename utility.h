...
namespace eastl
{
	...
	inline void iterSwap(ForwardIterator1 a, ForwardIterator2 b)
	{
		...
		eastl::iterSwap_impl<eastl::conjunction<eastl::is_same<value_type_a, value_type_b>, eastl::is_same<value_type_a&, reference_a>, eastl::is_same<value_type_b&, reference_b>>::value >::iterSwap(a, b);
	}
	...
	///
	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_equal(const T x, const U y) EASTL_NOEXCEPT
	{
	...
	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_not_equal(const T x, const U y) EASTL_NOEXCEPT
		{ return !eastl::cmp_equal(x, y); }


	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_less(const T x, const U y) EASTL_NOEXCEPT
	{
		static_assert(eastl::is_integral_v<T> && !eastl::is_same_v<eastl::remove_cv_t<T>, bool> && !eastl::is_same_v<eastl::remove_cv_t<T>, char>);
		static_assert(eastl::is_integral_v<U> && !eastl::is_same_v<eastl::remove_cv_t<U>, bool> && !eastl::is_same_v<eastl::remove_cv_t<U>, char>);
	...
	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_greater(const T x, const U y) EASTL_NOEXCEPT
		{ return eastl::cmp_less(y, x); }


	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_less_equal(const T x, const U y) EASTL_NOEXCEPT
		{ return !eastl::cmp_greater(x, y); }


	template <typename T, typename U>
	EA_CONSTEXPR bool cmp_greater_equal(const T x, const U y) EASTL_NOEXCEPT
		{ return !eastl::cmp_less(x, y); }


	template <typename T, typename U>
	EA_CONSTEXPR bool in_range(const U x) EASTL_NOEXCEPT
	{
		static_assert(eastl::is_integral_v<T> && !eastl::is_same_v<eastl::remove_cv_t<T>, bool> && !eastl::is_same_v<eastl::remove_cv_t<T>, char>);
		static_assert(eastl::is_integral_v<U> && !eastl::is_same_v<eastl::remove_cv_t<U>, bool> && !eastl::is_same_v<eastl::remove_cv_t<U>, char>);
	...
	public:
		...
		void swap(pair& p) EASTL_NOEXCEPT_IF(eastl::is_nothrow_swappable_v<T1>&& eastl::is_nothrow_swappable_v<T2>)
		{
	...
	#if defined(_MSC_VER)
		template <typename T1, typename T2>
		EA_CPP14_CONSTEXPR inline pair<T1, T2> makePair(
			const T1& a,
			const T2& b,
