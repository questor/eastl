...
namespace eastl
{
	...
	vector_multimap<K, T, C, A, RAC>::find_as(const U& u, BinaryPredicate predicate) const
	{
		...
		const eastl::pair<const_iterator, const_iterator> pairIts(eastl::equalRange(begin(), end(), u, predicate_cmp));
	...
	{
		multimap_value_compare<U, value_type, BinaryPredicate> predicate_cmp(predicate);
		const eastl::pair<iterator, iterator> pairIts(eastl::equalRange(begin(), end(), u, predicate_cmp));
		return (pairIts.first != pairIts.second) ? pairIts.first : end();
	}
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline typename vector_multimap<K, T, C, A, RAC>::iterator
	vector_multimap<K, T, C, A, RAC>::lowerBound(const key_type& k)
	{
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline typename vector_multimap<K, T, C, A, RAC>::const_iterator
	vector_multimap<K, T, C, A, RAC>::lowerBound(const key_type& k) const
	{
		return eastl::lowerBound(begin(), end(), k, mValueCompare);
	}
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline typename vector_multimap<K, T, C, A, RAC>::iterator
	vector_multimap<K, T, C, A, RAC>::upperBound(const key_type& k)
	{
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline typename vector_multimap<K, T, C, A, RAC>::const_iterator 
	vector_multimap<K, T, C, A, RAC>::upperBound(const key_type& k) const
	{
		return eastl::upperBound(begin(), end(), k, mValueCompare);
	}
	...
	vector_multimap<K, T, C, A, RAC>::equalRange(const key_type& k)
	{
		return eastl::equalRange(begin(), end(), k, mValueCompare);
	}
	...
	vector_multimap<K, T, C, A, RAC>::equalRange(const key_type& k) const
	{
		return eastl::equalRange(begin(), end(), k, mValueCompare);
	}
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline eastl::pair<typename vector_multimap<K, T, C, A, RAC>::iterator, typename vector_multimap<K, T, C, A, RAC>::iterator>
	vector_multimap<K, T, C, A, RAC>::equalRange_small(const key_type& k)
	{
		const iterator itLower(lowerBound(k));
		iterator       itUpper(itLower);
	...
	*/
	...
	template <typename K, typename T, typename C, typename A, typename RAC>
	inline eastl::pair<typename vector_multimap<K, T, C, A, RAC>::const_iterator, typename vector_multimap<K, T, C, A, RAC>::const_iterator>
	vector_multimap<K, T, C, A, RAC>::equalRange_small(const key_type& k) const
	{
