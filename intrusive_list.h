...
namespace eastl
{
	...
	public:
	   ...
	   ~intrusive_list_base();
		...
		eastl_size_t    size() const EASTL_NOEXCEPT;  ///< Returns the number of elements in the list; O(n).
		void            clear() EASTL_NOEXCEPT;       ///< Clears the list; O(1). No deallocation occurs.
		...
		EASTL_API void  reverse() EASTL_NOEXCEPT;     ///< Reverses a list so that front and back are swapped; O(n).
	...
	///    intList.pushBack(nodeA);
	///    intList.pushBack(nodeB);
	...
	public:
	  ...
	  //intrusive_list(std::initializer_list<value_type> ilist); To consider: Is this feasible, given how initializer_list works by creating a temporary array? Even if it is feasible, is it a good idea?
		...
		iterator                begin() EASTL_NOEXCEPT;                 ///< Returns an iterator pointing to the first element in the list.
		const_iterator          begin() const EASTL_NOEXCEPT;           ///< Returns a const_iterator pointing to the first element in the list.
		const_iterator          cbegin() const EASTL_NOEXCEPT;          ///< Returns a const_iterator pointing to the first element in the list.

		iterator                end() EASTL_NOEXCEPT;                   ///< Returns an iterator pointing one-after the last element in the list.
		const_iterator          end() const EASTL_NOEXCEPT;             ///< Returns a const_iterator pointing one-after the last element in the list.
		const_iterator          cend() const EASTL_NOEXCEPT;            ///< Returns a const_iterator pointing one-after the last element in the list.

		reverse_iterator        rbegin() EASTL_NOEXCEPT;                ///< Returns a reverse_iterator pointing at the end of the list (start of the reverse sequence).
		const_reverse_iterator  rbegin() const EASTL_NOEXCEPT;          ///< Returns a const_reverse_iterator pointing at the end of the list (start of the reverse sequence).
		const_reverse_iterator  crbegin() const EASTL_NOEXCEPT;         ///< Returns a const_reverse_iterator pointing at the end of the list (start of the reverse sequence).

		reverse_iterator        rend() EASTL_NOEXCEPT;                  ///< Returns a reverse_iterator pointing at the start of the list (end of the reverse sequence).
		const_reverse_iterator  rend() const EASTL_NOEXCEPT;            ///< Returns a const_reverse_iterator pointing at the start of the list (end of the reverse sequence).
		const_reverse_iterator  crend() const EASTL_NOEXCEPT;           ///< Returns a const_reverse_iterator pointing at the start of the list (end of the reverse sequence).
		...
		void        pushFront(value_type& x);             ///< Adds an element to the front of the list; O(1). The element is not copied. The element must not be in any other list.
		void        pushBack(value_type& x);              ///< Adds an element to the back of the list; O(1). The element is not copied. The element must not be in any other list.
	...
	inline bool intrusive_list_base::empty() const EASTL_NOEXCEPT
	{
		return mAnchor.mpPrev == &mAnchor;
	}


	inline intrusive_list_base::size_type intrusive_list_base::size() const EASTL_NOEXCEPT
	{
	...
	inline void intrusive_list_base::clear() EASTL_NOEXCEPT
	{
		#if EASTL_VALIDATE_INTRUSIVE_LIST
	...
	inline void intrusive_list_base::popFront()
	{
		...
		mAnchor.mpNext = mAnchor.mpNext->mpNext;
			...
			if(pNode != &mAnchor)
				...
				EASTL_FAIL_MSG("intrusive_list::popFront(): empty list.");
			#endif
		#endif
	}
	...
	inline void intrusive_list_base::popBack()
	{
		...
		mAnchor.mpPrev = mAnchor.mpPrev->mpPrev;
			...
			if(pNode != &mAnchor)
				...
				EASTL_FAIL_MSG("intrusive_list::popBack(): empty list.");
			#endif
		#endif
	}
	...
	template <typename T>
	inline typename intrusive_list<T>::iterator intrusive_list<T>::begin() EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_iterator intrusive_list<T>::begin() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_iterator intrusive_list<T>::cbegin() const EASTL_NOEXCEPT
	{
		return const_iterator(static_cast<T*>(mAnchor.mpNext));
	}
	...
	template <typename T>
	inline typename intrusive_list<T>::iterator intrusive_list<T>::end() EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_iterator intrusive_list<T>::end() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_iterator intrusive_list<T>::cend() const EASTL_NOEXCEPT
	{
		return const_iterator(static_cast<const T*>(&mAnchor));
	}
	...
	template <typename T>
	inline typename intrusive_list<T>::reverse_iterator intrusive_list<T>::rbegin() EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::rbegin() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::crbegin() const EASTL_NOEXCEPT
	{
		return const_reverse_iterator(const_iterator(static_cast<const T*>(&mAnchor)));
	}
	...
	template <typename T>
	inline typename intrusive_list<T>::reverse_iterator intrusive_list<T>::rend() EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::rend() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::crend() const EASTL_NOEXCEPT
	{
		return const_reverse_iterator(const_iterator(static_cast<const T*>(mAnchor.mpNext)));
	}
	...
	template <typename T>
	inline void intrusive_list<T>::pushFront(value_type& x)
	{
		#if EASTL_VALIDATE_INTRUSIVE_LIST && EASTL_ASSERT_ENABLED
			if(x.mpNext || x.mpPrev)
				EASTL_FAIL_MSG("intrusive_list::pushFront(): element already on a list.");
		#endif
	...
	template <typename T>
	inline void intrusive_list<T>::pushBack(value_type& x)
	{
		#if EASTL_VALIDATE_INTRUSIVE_LIST && EASTL_ASSERT_ENABLED
			if(x.mpNext || x.mpPrev)
				EASTL_FAIL_MSG("intrusive_list::pushBack(): element already on a list.");
		#endif
	...
	template <typename T>
	inline int intrusive_list<T>::validateIterator(const_iterator i) const
	{
