...
namespace eastl
{
	namespace Internal
	{
			...
			mutex::mutex()
			{
					...
					//static_assert(EASTL_ALIGN_OF(mMutexBuffer) >= EASTL_ALIGN_OF(CRITICAL_SECTION), "mMutexBuffer alignment failure"); // Enabling this causes the VS2012 compiler to crash.
