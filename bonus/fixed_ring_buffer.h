...
namespace eastl
{
	...
	/// ring_buffer using eastl::fixedVector as its storage container. This has
	...
	///
	/// We are over-allocating the fixedVector container to accommodate the
	...
	using fixed_ring_buffer =
	    ring_buffer<T, fixedVector<T, N + 1, false>, typename fixedVector<T, N + 1, false>::overflow_allocator_type>;
#endif
