...
namespace eastl
{
	...
	/// can pass any kind of char-based string, including a fixedString, and the 
	...
	public:
		...
		template <typename U, typename A> friend class basicString;
	...
	public:
		...
		bool      empty() const EASTL_NOEXCEPT;                // Expanded in source code as: (mpBegin == mpEnd) or (mpBegin != mpEnd)
		size_type size() const EASTL_NOEXCEPT;                 // Expanded in source code as: (size_type)(mpEnd - mpBegin)
		size_type length() const EASTL_NOEXCEPT;               // Expanded in source code as: (size_type)(mpEnd - mpBegin)
		size_type maxSize() const EASTL_NOEXCEPT;             // Expanded in source code as: kMaxSize
		size_type capacity() const EASTL_NOEXCEPT;             // Expanded in source code as: (size_type)((mpCapacity - mpBegin) - 1)
		...
		size_type findFirstOf(const this_type& x, size_type position = 0) const;
		...
		size_type findLastOf(const this_type& x, size_type position = npos) const;
		...
		size_type findFirstNotOf(const this_type& x, size_type position = 0) const;
		...
		size_type findLastNotOf(const this_type& x,  size_type position = npos) const;
	...
	class basicString : public abstract_string<T>
	{
	public:
		...
		using base_type::appendSprintfVaList;
	   ...
	   ~basicString();
		...
		this_type& appendSprintfVaList(const value_type* pFormat, va_list arguments) { return (this_type&)base_type::appendSprintfVaList(pFormat, arguments); }
		this_type& appendSprintf(const value_type* pFormat, ...)                       { va_list arguments; va_start(arguments, pFormat); this_type& r = (this_type&)base_type::appendSprintfVaList(pFormat, arguments); va_end(arguments); return r; }
		...
		this_type& sprintfVaList(const value_type* pFormat, va_list arguments) { return (this_type&)base_type::sprintfVaList(pFormat, arguments); }
		this_type& sprintf(const value_type* pFormat, ...)                     { va_list arguments; va_start(arguments, pFormat); this_type& r = (this_type&)base_type::sprintfVaList(pFormat, arguments); va_end(arguments); return r; }
	...
	template <typename T, typename Allocator>
	inline basicString<T, Allocator>::basicString(const base_type& x)
	  : base_type(&AllocFreeMethod),
		mAllocator(EASTL_BASIC_STRING_DEFAULT_NAME)
	{
		RangeInitialize(x.mpBegin, x.mpEnd);
		...
		mAllocator()
	{
		...
		/* To do.
		template <typename T, typename Allocator>
		inline basicString<T, Allocator>::basicString(this_type&& x)
			: mpBegin(NULL),
			  mpEnd(NULL),
			  mpCapacity(NULL),
			  mAllocator()
	...
	abstract_string<T>::begin() EASTL_NOEXCEPT
	{
		return mpBegin;
	}
	...
	abstract_string<T>::begin() const EASTL_NOEXCEPT
	{
		return mpBegin;
	}
	...
	template <typename T>
	inline typename abstract_string<T>::const_iterator
	abstract_string<T>::cbegin() const EASTL_NOEXCEPT
	{
		return mpBegin;
	}
	...
	template <typename T>
	inline typename abstract_string<T>::iterator
	abstract_string<T>::end() EASTL_NOEXCEPT
	{
		return mpEnd;
	}
	...
	template <typename T>
	inline typename abstract_string<T>::const_iterator
	abstract_string<T>::end() const EASTL_NOEXCEPT
	{
		return mpEnd;
	}
	...
	template <typename T>
	inline typename abstract_string<T>::const_iterator
	abstract_string<T>::cend() const EASTL_NOEXCEPT
	{
		return mpEnd;
	}
	...
	abstract_string<T>::rbegin() EASTL_NOEXCEPT
	{
	...
	abstract_string<T>::rbegin() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename abstract_string<T>::const_reverse_iterator
	abstract_string<T>::crbegin() const EASTL_NOEXCEPT
	{
		return const_reverse_iterator(mpEnd);
	}
	...
	template <typename T>
	inline typename abstract_string<T>::reverse_iterator
	abstract_string<T>::rend() EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename abstract_string<T>::const_reverse_iterator
	abstract_string<T>::rend() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename abstract_string<T>::const_reverse_iterator
	abstract_string<T>::crend() const EASTL_NOEXCEPT
	{
		return const_reverse_iterator(mpBegin);
	}
	...
	template <typename T>
	inline bool abstract_string<T>::empty() const EASTL_NOEXCEPT
	{
	...
	abstract_string<T>::size() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::length() const EASTL_NOEXCEPT
	{
		return (size_type)(mpEnd - mpBegin);
	}
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::maxSize() const EASTL_NOEXCEPT
	{
		return kMaxSize;
	}
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::capacity() const EASTL_NOEXCEPT
	{
	...
	template <typename T>
	inline void abstract_string<T>::setCapacity(size_type n)
	{
	...
	template <typename T>
	inline void abstract_string<T>::forceSize(size_type n)
	{
		#if EASTL_STRING_OPT_RANGE_ERRORS
			...
			if(EASTL_UNLIKELY(n >= (size_type)(mpCapacity - mpBegin)))
				EASTL_FAIL_MSG("abstract_string::forceSize -- out of range");
		#endif
	...
	template <typename T>
	abstract_string<T>& abstract_string<T>::appendSprintfVaList(const value_type* pFormat, va_list arguments)
	{
	...
	template <typename T>
	abstract_string<T>& abstract_string<T>::appendSprintf(const value_type* pFormat, ...)
	{
		va_list arguments;
		va_start(arguments, pFormat);
		appendSprintfVaList(pFormat, arguments);
	...
	template <typename T>
	inline void abstract_string<T>::pushBack(value_type c)
	{
	...
	template <typename T>
	inline void abstract_string<T>::popBack()
	{
		#if EASTL_ASSERT_ENABLED
			if(EASTL_UNLIKELY(mpEnd <= mpBegin))
				EASTL_FAIL_MSG("abstract_string::popBack -- empty string");
		#endif
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findFirstOf(const this_type& x, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type 
	abstract_string<T>::findFirstOf(const value_type* p, size_type position) const
	{
		...
		template <typename T>
		typename abstract_string<T>::size_type
		abstract_string<T>::findFirstOf(const value_type* p, size_type position, size_type n) const
		{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findFirstOf(value_type c, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findLastOf(const this_type& x, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findLastOf(const value_type* p, size_type position) const
	{
	...
	template <typename T>
	typename abstract_string<T>::size_type
	abstract_string<T>::findLastOf(const value_type* p, size_type position, size_type n) const
	{
		// If n is zero or position is >= size, we return npos.
		const size_type nLength = (size_type)(mpEnd - mpBegin);
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findLastOf(value_type c, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findFirstNotOf(const this_type& x, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findFirstNotOf(const value_type* p, size_type position) const
	{
	...
	template <typename T>
	typename abstract_string<T>::size_type
	abstract_string<T>::findFirstNotOf(const value_type* p, size_type position, size_type n) const
	{
		if(EASTL_LIKELY(position <= (size_type)(mpEnd - mpBegin)))
		{
	...
	template <typename T>
	typename abstract_string<T>::size_type
	abstract_string<T>::findFirstNotOf(value_type c, size_type position) const
	{
		if(EASTL_LIKELY(position <= (size_type)(mpEnd - mpBegin)))
		{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findLastNotOf(const this_type& x, size_type position) const
	{
	...
	template <typename T>
	inline typename abstract_string<T>::size_type
	abstract_string<T>::findLastNotOf(const value_type* p, size_type position) const
	{
	...
	template <typename T>
	typename abstract_string<T>::size_type
	abstract_string<T>::findLastNotOf(const value_type* p, size_type position, size_type n) const
	{
		const size_type nLength = (size_type)(mpEnd - mpBegin);
	...
	template <typename T>
	typename abstract_string<T>::size_type
	abstract_string<T>::findLastNotOf(value_type c, size_type position) const
	{
		const size_type nLength = (size_type)(mpEnd - mpBegin);
	...
	inline abstract_string<T> abstract_string<T>::substr(size_type position, size_type n) const
	{
		...
		x.assign(mpBegin + position, mpBegin + position + eastl::minAlt(n, (size_type)(mpEnd - mpBegin) - position));
		return x;
	}
	...
	inline int abstract_string<T>::compare(size_type pos1, size_type n1, const this_type& x, size_type pos2, size_type n2) const
	{
		...
		return compare(mpBegin + pos1, 
					   mpBegin + pos1 + eastl::minAlt(n1, (size_type)(mpEnd - mpBegin) - pos1),
					   x.mpBegin + pos2, 
					   x.mpBegin + pos2 + eastl::minAlt(n2, (size_type)(x.mpEnd - x.mpBegin) - pos2));
	}
	...
	template <typename T>
	inline void abstract_string<T>::makeLower()
	{
	...
	// Anything more complicated should use a more powerful separate library.
	template <typename T>
	inline void abstract_string<T>::makeUpper()
	{
		for(pointer p = mpBegin; p < mpEnd; ++p)
	...
	template <typename T>
	abstract_string<T>& abstract_string<T>::sprintfVaList(const value_type* pFormat, va_list arguments)
	{
		mpEnd = mpBegin; // Fast truncate to zero length.
	...
	template <typename T>
	inline int abstract_string<T>::validateIterator(const_iterator i) const
	{
		if(i >= mpBegin)
		{
			if(i < mpEnd)
	...
	// Operator +
	template <typename T, typename Allocator>
	basicString<T, Allocator> operator+(const basicString<T, Allocator>& a, const abstract_string<T>& b)
	{
	...
	template <typename T, typename Allocator>
	inline basicString<T, Allocator>& basicString<T, Allocator>::operator=(const base_type& x)
	{
		if(&x != this)
		{
	...
	inline bool operator<(const typename abstract_string<T>::value_type* p, const abstract_string<T>& b)
	{
		typedef typename abstract_string<T>::size_type size_type;
		const size_type n = (size_type)CharStrlen(p);
		return basicString<T>::compare(p, p + n, b.begin(), b.end()) < 0;
	}
