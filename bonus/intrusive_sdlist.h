...
namespace eastl
{
	...
	public:
		...
		void      popFront();              ///< Removes an element from the front of the list; O(1). The element must be present, but is not deallocated.
	...
	public:
		...
		void             pushFront(value_type& value);                  ///< Adds an element to the front of the list; O(1). The element is not copied. The element must not be in any other list.
		void             pushBack(value_type& value);                   ///< Adds an element to the back of the list; O(N). The element is not copied. The element must not be in any other list.
		void             popBack();                                     ///< Removes an element from the back of the list; O(N). The element must be present, but is not deallocated.
	...
	inline void intrusive_sdlist_base::popFront()
	{
	...
	template <typename T>
	inline void intrusive_sdlist<T>::pushFront(value_type& value)
	{
		value.mpNext = mpNext;
	...
	template <typename T>
	inline void intrusive_sdlist<T>::pushBack(value_type& value)
	{
	...
	template <typename T>
	inline void intrusive_sdlist<T>::popBack()
	{
	...
	template <typename T>
	inline int intrusive_sdlist<T>::validateIterator(const_iterator i) const
	{
