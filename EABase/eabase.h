...
#if defined(EA_COMPILER_GNUC) || defined(EA_COMPILER_MSVC) || defined(EASTL_WCHAR_T_NON_NATIVE) || defined(CS_UNDEFINED_STRING)
...
#if defined(EA_COMPILER_HAS_INTTYPES) && ( !defined(EA_COMPILER_MSVC) || (_MSC_VER >= 1800))
...
// _CHAR16T and let EABase define char16_t and EASTL_CHAR16.
//
...
// takes a unicode string.
	...
	// To do: Change this to be based on EA_COMPILER_NO_NEW_CHARACTER_TYPES.
	...
	#elif defined(EA_COMPILER_CLANG) && defined(EASTL_COMPILER_CPP11_ENABLED)
		...
		#endif
	#elif defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 404) && defined(__CHAR16_TYPE__) && defined(EASTL_COMPILER_CPP11_ENABLED)// EDG 4.4+.
		#define EASTL_CHAR16_NATIVE 1
	#elif defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004) && !defined(EA_COMPILER_EDG) && (defined(EASTL_COMPILER_CPP11_ENABLED) || defined(__STDC_VERSION__)) // g++ (C++ compiler) 4.4+ with -std=c++0x or gcc (C compiler) 4.4+ with -std=gnu99
		#define EASTL_CHAR16_NATIVE 1
	#else
		#define EASTL_CHAR16_NATIVE 0
	#endif
...
#if !defined(EASTL_CHAR32_NATIVE)                    // Microsoft currently ties char32_t language support to char16_t language support. So we use CHAR16_T here.
	// To do: Change this to be based on EA_COMPILER_NO_NEW_CHARACTER_TYPES.
	#if defined(_MSC_VER) && (_MSC_VER >= 1600) && defined(_HAS_CHAR16_T_LANGUAGE_SUPPORT) && _HAS_CHAR16_T_LANGUAGE_SUPPORT // VS2010+
		...
		#endif
	#elif defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 404) && defined(__CHAR32_TYPE__) && defined(EASTL_COMPILER_CPP11_ENABLED)// EDG 4.4+.
		#define EASTL_CHAR32_NATIVE 1
	#elif defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004) && !defined(EA_COMPILER_EDG) && (defined(EASTL_COMPILER_CPP11_ENABLED) || defined(__STDC_VERSION__)) // g++ (C++ compiler) 4.4+ with -std=c++0x or gcc (C compiler) 4.4+ with -std=gnu99
		#define EASTL_CHAR32_NATIVE 1
	#else
...
#if EASTL_CHAR16_NATIVE || EASTL_CHAR32_NATIVE
...
// EA_CHAR8 / EASTL_CHAR16 / EASTL_CHAR32 / EA_WCHAR 
//
...
//
	...
	#define EA_WCHAR(s)  EA_WCHAR_(s)
		...
		#define EASTL_CHAR16_(s) u ## s
		#define EASTL_CHAR16(s)  EASTL_CHAR16_(s)
	#elif (EASTL_WCHAR_SIZE == 2)
		#if defined(_MSC_VER) && (_MSC_VER >= 1900) && defined(__cplusplus) // VS2015 supports u"" string literals.
			#define EASTL_CHAR16_(s) u ## s
			#define EASTL_CHAR16(s)  EASTL_CHAR16_(s)
		#else
			#define EASTL_CHAR16_(s) L ## s
			#define EASTL_CHAR16(s)  EASTL_CHAR16_(s)
		#endif
	#else
		//#define EASTL_CHAR16(s) // Impossible to implement efficiently.
	#endif
#endif

#ifndef EASTL_CHAR32
	#if EASTL_CHAR32_NATIVE && !defined(_MSC_VER) // Microsoft doesn't support char32_t string literals.
		#define EASTL_CHAR32_(s) U ## s
		#define EASTL_CHAR32(s)  EASTL_CHAR32_(s)
	#elif (EASTL_WCHAR_SIZE == 2)
		#if defined(_MSC_VER) && (_MSC_VER >= 1900) && defined(__cplusplus) // VS2015 supports u"" string literals.
			#define EASTL_CHAR32_(s) U ## s
			#define EASTL_CHAR32(s)  EASTL_CHAR32_(s)
		...
		#endif
	#elif (EASTL_WCHAR_SIZE == 4)
		#define EASTL_CHAR32_(s) L ## s
		#define EASTL_CHAR32(s)  EASTL_CHAR32_(s)
	#else
...
//
	...
	#define EAText16(x)  EASTL_CHAR16(x)
	#define EAChar16(x)  EASTL_CHAR16(x)
#endif
...
//
	...
	#define EASTLArrayCount(x) (sizeof(EAArraySizeHelper(x)))
#endif
...
#elif defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 401) && defined(EASTL_COMPILER_CPP11_ENABLED)
	// static_assert is defined by the compiler.
#else
	#define NEED_CUSTOM_STATIC_ASSERT
#endif
