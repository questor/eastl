...
// #include <array>, <forward_list>, <ununordered_set>, <unordered_map>
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004) // Actually GCC 4.3 supports array and unordered_
		#define EA_HAVE_CPP11_CONTAINERS 1
...
// #include <atomic>
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4007)
		#define EA_HAVE_CPP11_ATOMIC 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_ATOMIC 1
	#else
...
// #include <future>
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4005)
		#define EA_HAVE_CPP11_FUTURE 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_FUTURE 1
	#else
...
// #include <type_traits>
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4007) // Prior versions of libstdc++ have incomplete support for C++11 type traits.
		#define EA_HAVE_CPP11_TYPE_TRAITS 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_TYPE_TRAITS 1
	#else
...
// #include <tuple>
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4003)
		#define EA_HAVE_CPP11_TUPLES 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_TUPLES 1
	#else
...
// #include <chrono> 
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4007) // chrono was broken in glibc prior to 4.7.
		#define EA_HAVE_CPP11_CHRONO 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_CHRONO 1
	#else
...
// #include <initializer_list> 
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_CLANG) && (EA_COMPILER_VERSION >= 301) && !defined(EA_COMPILER_NO_INITIALIZER_LISTS) && !defined(EA_PLATFORM_APPLE)
		#define EA_HAVE_CPP11_INITIALIZER_LIST 1
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBCPP_LIBRARY) && defined(EA_COMPILER_CLANG) && (EA_COMPILER_VERSION >= 301) && !defined(EA_COMPILER_NO_INITIALIZER_LISTS) && !defined(EA_PLATFORM_APPLE)
		#define EA_HAVE_CPP11_INITIALIZER_LIST 1
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004) && !defined(EA_COMPILER_NO_INITIALIZER_LISTS) && !defined(EA_PLATFORM_APPLE)
		#define EA_HAVE_CPP11_INITIALIZER_LIST 1
...
// #include <system_error> 
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_CLANG) && (EA_COMPILER_VERSION >= 301) && !defined(EA_PLATFORM_APPLE)
		#define EA_HAVE_CPP11_SYSTEM_ERROR 1
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004) && !defined(EA_PLATFORM_APPLE)
		#define EA_HAVE_CPP11_SYSTEM_ERROR 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_SYSTEM_ERROR 1
	#else
...
// #include <codecvt> 
	...
	//#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4008)
	//    #define EA_HAVE_CPP11_CODECVT 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_CODECVT 1
	#else
...
// #include <typeindex> 
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4006)
		#define EA_HAVE_CPP11_TYPEINDEX 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_TYPEINDEX 1
	#else
...
// <memory>: std::weak_ptr, std::shared_ptr, std::unique_ptr, std::bad_weak_ptr, std::owner_less
	...
	#elif defined(EASTL_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4004)
		#define EA_HAVE_CPP11_SMART_POINTER_IMPL 1
	#elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
		#define EA_HAVE_CPP11_SMART_POINTER_IMPL 1
	#else
