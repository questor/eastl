...
namespace eastl
{
	...
	#if EASTL_CHAR16_NATIVE // If char16_t is a true unique type (as called for by the C++11 Standard)...
	...
	#if EASTL_CHAR32_NATIVE // If char32_t is a true unique type (as called for by the C++11 Standard)...
